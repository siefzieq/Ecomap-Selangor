...
@section('caption', 'Add Repository')
@section('content')
    <div style="background-color: #ffffff; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.15); position: relative; margin-top: 3%; left: -0.5%; width: 96%; height: 70%; overflow: hidden;">
        <div style="height: calc(100% - 20px); overflow-y: auto;">
            ...
            <form method="POST" action="{{route('repository.store')}}"  enctype="multipart/form-data" style="width: 100%;">
                @csrf
                <label class="form-label">Name</label>
                <input type="text" class="form-control" id="file_name" name="file_name" placeholder="Enter the file name"  style="width: 95%;" autocomplete="off" required><br>

                <label class="form-label">Type</label>
                <select class="form-select form-control" id="file_type" name="file_type" style="width: 95%;" required>
                ...
                <textarea class="form-control" id="description" name="description" rows="4" placeholder="Description of the file" style="width: 95%;"></textarea><br>
                ...
                <select class="form-select form-control" id="category" name="category" style="width: 95%;" required>
                    ...
                    <option value="flat-related">Flat-related</option>
                </select><br>
